...
--better indentation
--vim.keymap.set('v', '<', '<gv', vim.opt)
--vim.keymap.set('v', '>', '>gv', vim.opt)

-- keep last yanked when pasting
--vim.keymap.set('v', 'p', '"_dP', vim.opt)
...
vim.keymap.set("n", "<leader>nh", ":nohl<CR>", { desc = "Clears search highlights" })
...
require("lazy").setup({
	...
	{ -- Fuzzy Finder (files, lsp, etc)
		...
		dependencies = {
			...
			{ "nvim-tree/nvim-web-devicons", enabled = true }, --vim.g.have_nerd_font },
		},
		config = function()
